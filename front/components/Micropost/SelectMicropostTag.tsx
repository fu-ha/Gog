...
const SelectMicropostTag = () => {
  ...
  return(
    <div className="relative inline-block ml-3 md:ml-5 my-3 md:my-5">
      <button onClick={() => setOpenTag(!openTag)} className="relative flex z-10 block p-2 text-gray-700 border border-transparent rounded-md dark:text-white focus:border-blue-500 focus:ring-opacity-40 dark:focus:ring-opacity-40 focus:ring-blue-300 dark:focus:ring-blue-400 focus:ring bg-gray-100 dark:bg-gray-800 focus:outline-none">

...
const MicropostCard = ({/*name, image_url, post*/}: PostCardProps) => {
  //{ user_data } = useUserSWR();
    ...
    <div className="max-w-2xl mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
      ...
      <div className="p-6">
        <div>
          ...
          <a href="#" className="block mt-2 text-2xl font-semibold text-gray-800 transition-colors duration-200 transform dark:text-white hover:text-gray-600 hover:underline">I Built A Successful Blog In One Year</a>
